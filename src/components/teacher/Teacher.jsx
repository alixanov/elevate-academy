...
import teacher2 from '../../assets/fizika.teacher2.png';
import teacher3 from '../../assets/math.teacher.png';
import teacher4 from '../../assets/fizika.teacher1.png';
import teacher5 from '../../assets/INGLIZ.TEACHER.PNG';
import teacher6 from '../../assets/fizika.teacher.png';
import teacher7 from '../../assets/ingliz teacher1.png';
import teacher8 from '../../assets/kimyo.teacher1.png';
import teacher9 from '../../assets/biologiya.teacher.png';
import teacher10 from '../../assets/kimyo.png';
...
import teacher14 from '../../assets/robotatexnika.teacher1.png';
...
const teachers = [
  { name: 'Isoqov Temurmalik', role: 'MATEMATIKA bo‘yicha ekspert', image: teacher12 },
  { name: 'Habibullayev Dilmurod', role: 'MATEMATIKA bo‘yicha mutaxassis', image: teacher4 },
  { name: 'Abdulvosilov Muhammadyusuf', role: 'MATEMATIKA bo‘yicha ekspert', image: teacher3 },
  { name: 'Axmadjonov Rustamjon', role: 'FIZIKA bo‘yicha ekspert', image: teacher1 },
  { name: 'Rahimov Yodgorbek', role: 'FIZIKA bo‘yicha mutaxassis', image: teacher9 },
  ...
  { name: 'Rizzayev Abdullo', role: 'INGLIZ TILI bo‘yicha mutaxassis', image: teacher14 },
  { name: 'Rasulov Nosirjon', role: 'BIOLOGIYA bo‘yicha ekspert', image: teacher8 },
  { name: 'Otamirzayev Komiljon', role: '🧬 KIMYO bo‘yicha ekspert', image: teacher2 },
  { name: 'Umidjon G‘oyipov', role: '🛡 KIBERXAVFSIZLIK bo‘yicha ekspert', image: teacher12 },
  { name: 'Abdumalikjanova Hilolabonu', role: '🛡 KIBERXAVFSIZLIK bo‘yicha mutaxassis', image: teacher11},
  ...
  { name: 'Dadamirzayeva Diyora', role: '🔍 ROBOTOTEXNIKA bo‘yicha ekspert', image: teacher10 },
  { name: 'Musoxanov Mohirjon', role: '🔍 ROBOTOTEXNIKA bo‘yicha mutaxassis', image: teacher5 },
];
